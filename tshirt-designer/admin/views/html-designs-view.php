...
<div class="td-grid td-grid--design-view">
	...
	<div class="td-col-side">
		...
		<table class="widefat striped">
			<tbody>
				<tr><td><?php esc_html_e( 'Model', 'tshirt-designer' ); ?></td><td>#<?php echo esc_html( (string) $design['model_id'] ); ?></td></tr>
				<tr><td><?php esc_html_e( 'Color', 'tshirt-designer' ); ?></td><td>#<?php echo esc_html( (string) $design['color_id'] ); ?></td></tr>
				<tr><td><?php esc_html_e( 'Size', 'tshirt-designer' ); ?></td><td>#<?php echo esc_html( (string) $design['size_id'] ); ?></td></tr>
		...
		<?php if ( array() !== $breakdown ) : ?>
			...
			<table class="widefat striped">
				<tbody>
					<tr><td><?php esc_html_e( 'Base product', 'tshirt-designer' ); ?></td><td><?php echo esc_html( $this->plugin->settings->format_price( (float) ( $breakdown['base_price'] ?? 0 ) ) ); ?></td></tr>
					<tr><td><?php esc_html_e( 'Size surcharge', 'tshirt-designer' ); ?></td><td><?php echo esc_html( $this->plugin->settings->format_price( (float) ( $breakdown['size_modifier'] ?? 0 ) ) ); ?></td></tr>
					<?php if ( isset( $breakdown['areas'] ) && is_array( $breakdown['areas'] ) ) : ?>
						<?php foreach ( $breakdown['areas'] as $area ) : ?>
							<tr>
								...
								<td><?php echo esc_html( $this->plugin->settings->format_price( (float) $area['subtotal'] ) ); ?></td>
							</tr>
						<?php endforeach; ?>
					<?php endif; ?>
					<tr class="td-row-total"><td><strong><?php esc_html_e( 'Total', 'tshirt-designer' ); ?></strong></td>
						<td><strong><?php echo esc_html( $this->plugin->settings->format_price( (float) ( $breakdown['total'] ?? $design['price_total'] ) ) ); ?></strong></td></tr>
				</tbody>
			</table>
		<?php endif; ?>
	</div>
