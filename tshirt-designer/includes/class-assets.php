...
final class Assets {
	...
	public static function boot_data( Plugin $plugin, int $initial_model, int $preload_design ): array {
		$i18n = array(
			...
			'addToCart'      => __( 'Add to cart', 'tshirt-designer' ),
			'addingToCart'   => __( 'Adding to cart…', 'tshirt-designer' ),
			'addedToCart'    => __( 'Added to your cart.', 'tshirt-designer' ),
			'cartError'      => __( 'Could not add the design to the cart.', 'tshirt-designer' ),
			'emptyDesign'    => __( 'Add some artwork or text before continuing.', 'tshirt-designer' ),
			'categories'     => array(
